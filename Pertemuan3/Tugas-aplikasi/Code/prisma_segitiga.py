...
sisi1.grid(row=5, column=0, sticky=W, padx=5, pady=5)

#Label Sisi2
sisi2 = Label(frame, text="Sisi2:")
sisi2.grid(row=6, column=0, sticky=W, padx=5, pady=5)

#Label Sisi3
sisi3 = Label(frame, text="Sisi3:")
sisi3.grid(row=7, column=0, sticky=W, padx=5, pady=5)
...
txtsisi1.grid(row=5, column=1)

#Textbox Sisi2
txtsisi2 = Entry (frame)
txtsisi2.grid(row=6, column=1)

#Textbox Sisi3
txtsisi3 = Entry (frame)
txtsisi3.grid(row=7, column=1)
...
luasalas.grid(row=9, column=0, sticky=W, padx=5, pady=5)

#Output Label Luas Sisi
luassisi = Label(frame, text="Luas Sisi:")
luassisi.grid(row=10, column=0, sticky=W, padx=5, pady=5)
...
txtluasalas.grid(row=9, column=1, sticky=W, padx=5, pady=5)

#Output Textbox Luas Sisi
txtluassisi = Entry (frame)
txtluassisi.grid(row=10, column=1, sticky=W, padx=5, pady=5)
